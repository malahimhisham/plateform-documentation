...
export default function Home() {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            ...
            setLoading(true);
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/pcategory3/all`, {
                    headers: {
    ...
    const fetchSubSessions = async (id) => {
        ...
        setLoading(true)
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/psubcategorysession3/search/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const fetchSessions = async (id) => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/pcategorysession3/search/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const fetchSubCategories = async () => {
        ...
        try {
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_BACKEND}/psubcategory3/all?categoryAssign=${selectedCategory._id}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
    ...
    const handleFeedBackHistroy = async () => {
        ...
        if (selectedSubCategory == null && selectedCategory) {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/pfeedback3/feedback/category`, {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${token}`,
            ...
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/pfeedback3/feedback/subcategory`, {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${token}`,
                        "Content-Type": "application/json",
    ...
    const handleFeedBack = async () => {
        ...
        if (selectedSubCategory == null) {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/pfeedback3/create`, {
                    method: "POST",
                    headers: {
                        Authorization: `Bearer ${token}`,
                        "Content-Type": "application/json",
