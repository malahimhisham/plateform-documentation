...
const SubCategory = ({ category, setIsSubCategory }) => {
    ...
    const fetchSessions = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/pcategorysession2/search/${category._id}`, {
                headers: {
    ...
    const moveSession = async (draggedId, targetId) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/pcategorysession2/update-order`, {
                method: 'PUT',
                headers: {
    ...
    const fetchSubCategories = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/psubcategory2/all?categoryAssign=${category._id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
