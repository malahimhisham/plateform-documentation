...
const SubCategorySession = ({subCategory, category, setIsSubCategory , setIsSessionOpen }) => {
    ...
    const fetchSessions = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/psubcategorysession2/search/${subCategory._id}`, {
                headers: {
    ...
    const moveSession = async (draggedId, targetId) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/psubcategorysession2/update-order`, {
                method: 'PUT',
                headers: {
