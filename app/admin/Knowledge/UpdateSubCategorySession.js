...
const UpdateSubCategorySession = ({ setUpdateSessionPopup, sessionData }) => {
    ...
    const handleUpdateSession = async () => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/psubcategorysession2/update/${sessionData._id}`, {
                method: "PUT",
                headers: {
...
export default UpdateSubCategorySession;
