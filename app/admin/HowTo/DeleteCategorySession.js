...
const DeleteCategorySession = ({ setIsDeleteSessionModalOpen, sessionToDelete, setSessionToDelete }) => {
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND}/pcategorysession1/delete/${sessionToDelete._id}`, {
                method: 'DELETE',
                headers: {
...
export default DeleteCategorySession;
