...
const AddCategorySession = ({ setIsSession, category }) => {
    ...
    const handleCreateSession = async () => {
        ...
        formData.append("categoryAssign", category._id);
        ...
        try {
            ...
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_BACKEND}/pcategorysession3/create`,
                {
                    method: "POST",
                    headers: {
...
export default AddCategorySession;
